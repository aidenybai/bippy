...
src/symbolic     inputs, guards, predicate serialization, constraint solving
src/evaluate     interpreter, values, completion, journals, operators, builtin methods, hooks/React calls
...
src/render       StaticRenderer, render contracts, root render discovery
