...
import type { FunctionLikeNode, ParsedSourceFile } from "../parse/source-types.js";
...
import type { Scope, StaticClassValue, StaticFunctionValue, StaticValue } from "../types.js";
import {
