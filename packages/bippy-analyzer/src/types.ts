import type { Class, Expression, Statement } from "oxc-parser";
import type { ImportedName, ModuleRecord } from "./graph/module-types.js";
...
export interface TaskBinder {
  <Arguments extends unknown[]>(task: (...args: Arguments) => void): (...args: Arguments) => void;
}
