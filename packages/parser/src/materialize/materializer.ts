...
export class Materializer {
      ...
      case "forward-ref": {
        ...
        return createElement(this.getForwardRefProxy(type), {
          ...
          input: {
            ...
            renderArguments: type.renderArguments,
          },
        });
      }
      case "lazy": {
  ...
  private renderArguments(
    ...
    if (ref === null) return [props];
    return (
      input.renderArguments?.(props, ref, this.stubTools(input.context, input.location)) ?? [
        props,
        ref,
      ]
    );
        ...
        this.evaluateComposite(
          ...
          (componentContext) =>
            this.interpreter.callFunction(
              ...
              this.renderArguments(input, props, ref),
              componentContext,
              { awaited: true },
            ),
        ),
