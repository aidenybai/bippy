...
/**
 * A bundler loader or plugin the app applies to a file extension, producing
 * the module the bundler links in place of the file. With `query` it only
...
export interface ProjectContext {
  ...
  mode: string;
  /** The Vite config file the dev server loads; `null` when none is found. */
