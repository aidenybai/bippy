...
// the first call runs synchronously. Every other helper runs from lodash's own
// source as a pure package or is analyzed when the package is allow-listed.
...
const MODELED_HELPERS = [...TRANSPARENT_WRAPPERS, ...RATE_LIMITERS];
