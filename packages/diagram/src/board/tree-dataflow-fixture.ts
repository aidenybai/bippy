...
export const treeDataflowPorts: TreeNode[] = [
  ...
  { id: "strong-content", label: "children", kind: "value", componentId: "strong" },
  { id: "strong-style", label: "style.color", kind: "value", componentId: "strong" },
  { id: "feed-items", label: "props.items", kind: "value", componentId: "feed" },
  { id: "feed-toggle", label: "props.onToggle", kind: "value", componentId: "feed" },
  { id: "post-item", label: "props.item", kind: "value", componentId: "post-1" },
  { id: "post-toggle", label: "props.onToggle", kind: "value", componentId: "post-1" },
  {
    id: "item-content",
    label: "children",
  ...
  { id: "item-click", label: "onClick", kind: "value", componentId: "item-1" },
  {
    id: "cart-click",
    label: "onClick",
  ...
  { id: "get-snapshot", label: "getSnapshot", kind: "store", componentId: "cart-store" },
  { id: "subscribe", label: "subscribe", kind: "store", componentId: "cart-store" },
