...
import { getRDTHook, _renderers } from "../../../bippy/src/index.js";
import { getFiberHooks, type HooksNode } from "../../../bippy/src/source/inspect-hooks.js";
...
describe("dispatcher-only hooks", () => {
  it("serves useMemoCache data from the fiber update queue", () => {
    ...
    expect(memoCache).toEqual({ data: [existingCacheEntry], index: 0 });
  });
