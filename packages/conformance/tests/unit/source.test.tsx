...
import { instrument } from "../../../bippy/src/index.js";
import {
  getSource,
  getOwnerStack,
  getParentStack,
  getSourceMap,
} from "../../../bippy/src/source/index.js";
import { sourceMapCache } from "../../../bippy/src/source/symbolication.js";
import { normalizeFileName } from "../../../bippy/src/source/get-source.js";
import {
  extractLocation,
  parseStack,
  type StackFrame,
