...
/**
 * Returns a descriptive string identifying the kind of a {@link Fiber} based on its work tag.
 */
export const getFiberKind = (fiber: Fiber): FiberKind => {
  switch (fiber.tag) {
