...
3. Root validation passes **2,864 tests**, with two existing React-19 DevTools skips; this includes **818 parser tests / 46 files**. Root typecheck/build, realm checks, lint and formatting pass. The latest serial corpus run takes 27.557 seconds for Sentry and 178.381 seconds for PostHog. Performance variability remains unresolved. P1/P2 and the 500-repository gate remain incomplete.
