...
3. Root validation passes **2,849 tests**, with two existing React-19 DevTools skips; this includes **803 parser tests / 44 files**. Root typecheck/build, realm checks, lint and formatting pass. The latest serial corpus run takes 28.480 seconds for Sentry and 188.288 seconds for PostHog. Performance variability remains unresolved. P1/P2 and the 500-repository gate remain incomplete.
